...
<div class="logo"><a href="#" ><img src="images/logo.png" alt="ACreations"></a></div>
...
<div class="block-big-listing block-big-listing-all list-hex-grid list-inline-block clearfix">
  

  <div class="list-big-block-row-a">
            	<a class="list-big-block-a hexagon sco " href="pages/week1.php">
                        ...
                        src="images/scoweek1.png" />
                        </canvas>
                 </a> 


                 <a class="list-big-block-a hexagon sco " href="pages/week2.php">
                        <span class="list-big-block-hover">
                            <h3>Conceptweek 2</h3>
                            <div class="list-big-block-excerpt">
 			...
 			<div class="list-big-block-row-b" style="top: -67px;">
            	<a class="list-big-block-b hexagon sco " href="pages/week3.php">
                        <span class="list-big-block-hover">
                            <h3>Conceptweek 3</h3>
                            <div class="list-big-block-excerpt">
                 ...
                 <a class="list-big-block-b hexagon sco " href="pages/week4.php">
                        <span class="list-big-block-hover">
                            <h3>Conceptweek 4</h3>
                            <div class="list-big-block-excerpt">
            ...
            <div class="list-big-block-row-b" style="top: -337px;">
                    ...
                    <a class="list-big-block-b hexagon sco " href="pages/scrumsprint2.php">
                        <span class="list-big-block-hover">
                            ...
                            <div class="list-big-block-excerpt">
                             In sprint 2 zijn we SCRUM meer gaan toepassen en hebben we een retrospective gehouden.    
                            </div>
                            <div class="list-big-block-view"><b>Bekijk</b></div>
                        </span>
                        <canvas id="list-big-block" class="list-big-block" width="640" height="664" style="width:320px; height:332px;">
                        <img id="list-big-img" class="list-big-img" 
                        src="images/scrumsp2.png" />
                        </canvas>
                 </a>  
